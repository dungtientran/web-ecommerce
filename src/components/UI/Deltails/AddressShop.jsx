...
const AddressShop = () => {
    ...
    return (
        <>
            <div>
                <button  className='bg-gray-200 hover:bg-blue-300 hover:text-white duration-700  p-2 rounded-lg text-sm font-semibold'>Toàn Quốc</button>
                ...
                <button className='bg-gray-200 hover:bg-blue-300 hover:text-white duration-700  p-2 rounded-lg text-sm font-semibold'>Hồ Chí Minh</button>
            </div>
