...
import { openBuyFast } from '../../redux/slice/cartSlice';
...
const BuyFast = () => {
    ...
    const id = useSelector((state) => state.cart?.buyFast);
        ...
        <>
            {isOpen ? (
                <div className=' flex items-center justify-center bg-black-rgba fixed top-0 right-0 w-full h-full z-10' onClick={() => dispatch(openBuyFast(null))}>
                    <div onClick={(e) => e.stopPropagation()} className='w-[60%] h-[70%] bg-white z-10'>
